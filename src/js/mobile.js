    ...
    if (window.matchMedia("(max-width : 767px)").matches) {
        header.innerHTML = `
            <div id="mySidenav" class="sidenav">
                ...
                <li class="dropdown-burger" id="dropdown"><a href="#">Nos chats<img src="file:///Users/dorivne/Les-Chats-de-la-Loyasse//assets/icones/arrow.png"></a>
                ...
                <li class="dropdown-burger" id="dropdown-2"><a href="#">Nos actions<img src="file:///Users/dorivne/Les-Chats-de-la-Loyasse//assets/icones/arrow.png"></a>
            ...
            <div class="logo"> <img src="file:///Users/dorivne/Les-Chats-de-la-Loyasse//assets/logo/logo.png" alt="Logo Association"> </div>`
