document.addEventListener("DOMContentLoaded", () => {
    ...
    function getAllNewsData() {
        ...
        return [
            ...
            { id: "5", title: "Luna 2", imageSrc: "static/temp/adoption1.jpg", description: "Luna est une boule d'amour..." },
        ...
        data.forEach(news => {
            ...
            if (photos.length > 0) { // On crée le conteneur de galerie s'il y a au moins une photo
                    ...
                    <div class="item-news-gallery">
                        <div class="gallery-carousel-container">
                            ...
                            <div class="carousel-buttons-container">
                                <ul class="pagination">
                                    <button class="carousel-prev" id="prevButton" aria-label="Photo précédente de la galerie"><img src="../static/icones/icon-arrow-2.svg" alt=""></button>
                                    <button class="carousel-next" id="nextButton" aria-label="Photo suivante de la galerie"><img src="../static/icones/icon-arrow-2.svg" alt=""></button>
                                </ul>
                            </div>
                            ` : ''}
                        </div>
                ...
                `;
                 ...
                 galleryHTML = `
                     <div class="item-news-gallery">
                         <img src="../static/temp/default-cat.jpg" alt="Image par défaut">
                     </div>
                 `;
            }
